...
a = p.parse_args()
query = '{__name__=~"ticketing_dispatch_probe_.*|ticketing_ingress_.*|ticketing_browse_body_.*|ticketing_hold_.*|ticketing_db_.*|ticketing_worker_.*|ticketing_reconciliation_.*|ticketing_cache_refresh_.*|up"}'
